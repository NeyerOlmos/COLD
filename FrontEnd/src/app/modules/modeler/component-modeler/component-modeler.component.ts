...
@Component({
  selector: 'app-component-modeler',
  templateUrl: './component-modeler.component.html',
  styleUrls: ['./component-modeler.component.scss'],
  encapsulation: ViewEncapsulation.ShadowDom
})

export class ComponentModelerComponent implements OnInit {
  ...
  public state = {
    ...
    { id:-6,
      key:"User",
    sourceMenu:"./../../../../assets/img/mobileApp.png",
    source:"./../../../../assets/img/mobileApp.png",
    width: 55,
    height: 55,
    //isGroup: true,
    alignmentText: new go.Spot(1, 1),
